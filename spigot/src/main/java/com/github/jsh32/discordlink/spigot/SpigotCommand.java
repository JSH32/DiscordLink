...
import com.github.jsh32.discordlink.core.framework.command.ArgumentData;
...
public class SpigotCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command commandObj, @NotNull String label, @NotNull String[] args) {
        ...
        com.github.jsh32.discordlink.core.framework.command.CommandSender sender =
                new com.github.jsh32.discordlink.core.framework.command.CommandSender(bukkitPlayer != null ? playerRegistry.getPlayer(bukkitPlayer) : null, plugin);
